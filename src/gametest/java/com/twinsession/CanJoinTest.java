...
public class CanJoinTest {
    ...
    public void firstJoinTest(GameTestHelper context) {
        ...
        context.assertTrue(TwinSession.canJoin(sourcePlayer), "Checking if player can join");
        context.succeed();
    }
    ...
    public void secondJoinTest(GameTestHelper context) {
        ...
        context.assertTrue(TwinSession.canJoin(sourcePlayer), "Checking if second player can join");
    ...
    public void tooManyJoinsTest(GameTestHelper context) {
        ...
        context.assertFalse(TwinSession.canJoin(sourcePlayer), "Checking if 9th player cannot join");
